...
Naj bo $\dP_n$ podprostor, ki ga množica $\{\partial^n\}$ napenja nad $\mathbb{R}$.
 ...
 $$p\in\dP\implies \exists_{\II}\Big(\D^np=\sum\limits_{i\in\II} c_ip_i\otimes(V^*)^{n\otimes}\Big)$$
  ...
  \end{equation}
   Zveza nam bo omogočila elegantno in učinkovito implementacijo odvodov poljubnega reda.
 ...
 \subsection{Razvoj v vrsto}
  ...
  Induktivno bi želeli program razvit v vrsto. Po Izreku $\ref{izr:linearnaNeodvisnost}$  obstaja prostor $\dP_n$, ki ga množica $\{\D^k\}$ napenja nad $\RR$. Zato je izraz
