...
\frac{d}{dh}e^{h\D_g}=\D_ge^{h\D_g}
 ...
 Sledimo nareku dosedanjih poglavij in podrobneje raziščimi operatorje nad programskimi jeziki $\dP$. Pričnemo s preslikavami ene spremenljivke. Naj bo operator $d=\frac{d}{dx}$. Definirajmo rodovno funkcijo v spremeljivki $t$
 ...
 Izraz $\Dplus f(x)$ razvijamo v vrsto v točki $t=0$, kot je razvidno je $\eqref{eq:DplusBasic}$, zato je edina izbira za konstantno $c=0$. Tako velja
