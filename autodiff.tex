...
\subsection{Optimizacija prostorske zahtevnosti}
 ...
 $$\exists_n(1-\Shift)=\Shift^n\in\Shift\implies \exists_m((1-\Shift)^{-1}\in\Shift^m\in \Shift)$$
 $$\implies$$
 ...
 Po Izreku $\ref{izr:linearnaNeodvisnost}$  obstaja prostor $\dP_n$, ki ga množica $\{\D^k\}$ napenja nad $\RR$. Zato je izraz   
  ...
  dobro definiran. Izkaže se $c_i=B_i$, kjer je $B_i$ $i$-ti Bernulijevo število. Operator $(1-\Shift^n)$ predstavlja ocenitev v krajiščih
