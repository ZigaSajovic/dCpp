...
d^nf=\sum_{\forall_{i,..,n}}\frac{\partial^n f}{\partial x_i...\partial x_n}dx_1\otimes dx_2\otimes...\otimes dx_n
\end{equation}
...
\begin{equation}
	\D^n=\sum\limits_{k=0}^{n}\sum_{\forall_{i,..,k}}\frac{\partial^n }{\partial x_i...\partial x_k}dx_1\otimes dx_2\otimes...\otimes dx_k
\end{equation}
 ...
 \end{equation}
 Tako so preslikave, ki operirajo nad univerzalnim vektorskim prostorom $V_n$ definirane kot slike operatorja $\D$. Operator seveda apliciramo nad $\T$.
 \begin{equation}
 	\D^n:\T\to \T^{n'}
 \end{equation}
 \begin{equation}
 	\T^{n'}:V_n\to V_n 
 \end{equation}
 Preslikave $\T^{n'}$ so podmnožica splošnejšega monoida $\F^n=\{f:V_n\to V_n\}$. Programe generirane s $\T^{n'}$, označimo s $P^{n'}$.
...
\begin{equation}
	e^d=\sum\limits_{n=0}^{\infty}\frac{1}{n!}\sum_{\forall_{i,..,j}}\frac{\partial^n }{\partial x_i...\partial x_n}dx_1\otimes dx_2\otimes...\otimes dx_n
\end{equation}
Za specifičen program $P\in\T$ velja
\begin{equation}
	(e^d)(P):V^i\to \VV^{ik}_{\JJ_k}\in V_n
\end{equation}
 ...
 \begin{equation}\label{eq:tenzorVrsta}
 	P(V+v) = \Big((e^d)(P)(V^i)\Big)v^{\JJ_k}_{k}
 \end{equation}
 
 $$P(V+v) = \VV^{ik}_{\JJ_k}v^{\JJ_k}_{k}$$
 
ki je upravičena z opažanjem, da za vse n velja
$$\lim\limits_{\lVert v\rVert\to 0}(\frac{\partial}{\partial v_i})^n\text{(leva stran)}=\lim\limits_{\lVert v\rVert\to 0}(\frac{\partial}{\partial v_i})^n\text{(desna stran)}$$
