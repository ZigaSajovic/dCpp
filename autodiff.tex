...
\begin{definicija}
  ...
  Za zgled uporabe teorije predstavljamo konstrukcijo analitičnega stroja, z zmožnostjo implementacije neskončno odvedljive različice programskega jezika $\CC$ nad virtualnim prostorom $V$ nad $K$.
...
\begin{lstlisting}
  ...
  T mul_make_pair(var_1 a, var_2 b) {
    return std::make_pair(a.first, a.second * b.reduceOrder());
  }
  \end{lstlisting}      
