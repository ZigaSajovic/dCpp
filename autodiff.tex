...
\frac{d}{dh}e^{h\D_g}=\D_ge^{h\D_g}
 ...
 Tako smo skozi osnovna pravila izračunali operator drugega odvoda kompozicije z $g$, ki ga apliciramo, na poljuben program. Rezultat se seveda ujema z enačbo $\eqref{eq:dComposite}$ za $n=2$.
