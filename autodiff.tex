...
<<<<<<< 7eede8c5455a57ca51a57f86ab2484fabf9b358f
...
V\oplus (V\otimes V) \oplus (V\otimes V\otimes V) \ldots$ odraža dejstvo, da za izračun vrednosti $n$-tega odvoda v neki točki $x\in V$
potrebujemo vrednosti funkcije in vseh nižjih odvodov.
\subsection{Odvedljivi stroji $\T$}
\begin{definicija}
  Trojico $(\T,V,\Op)$ imenujemo \emph{odvedljiv stroj}.
\end{definicija}
Če je $(\T,V,\Op)$ odvedljiv stroj, je $(\T',V',\Op')$ tudi odvedljiv stroj.
