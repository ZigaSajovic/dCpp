...
Naj bo $\dP_n$ podprostor, ki ga množica $\{\partial^n\}$ napenja nad $\mathbb{R}$.
 ...
 \begin{izrek}\label{izr:T_n}
 	Funkcijski prostor $\dP_n$ je izomorfen tenzorskem produktu funkcijskega prostora $\dP_0$ in tenzorske algebre duala $T(V^*)$ virtualnega prostora $V$.
 \end{izrek}
...
preslikavo $\dP_0\to\dP_n$. To pomeni, da lahko programski jezik $n$-tega reda generiramo skozi linearne kombinacije prvotnega programskega jezika $\dP_0$ in virtualnim prostorom $V$.
