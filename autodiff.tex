...
\newenvironment{cc}{\begin{lstlisting}}{\end{lstlisting}}
...
\begin{definicija}
   Dvojec $M=\langle\dP, V\rangle$ je analitičen, naskončno-krat odvedljiv računski stroj.
    ...
    \end{itemize}
  \end{definicija}
  Vse kar operira pod temi specifikacijami je $\textit{analitičen računski stroj}$ z zmožnostjo implementacije neskončno odvedljivega programskega jezika $\dP_\infty$. 
\end{document}
