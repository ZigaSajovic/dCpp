...
%kar sledi ne vem če naj dava noter, ti presodi 
Podobno lahko definiramo tenzor, generiran z exponentno mapo $e^\VV$
\begin{equation}\label{eq:tenzor}
	V^{\JJ_k}_{k}=\bigoplus\limits_{0\le k\le n} \frac{1}{\lvert\JJ\rvert!}V^{\JJ_k}_{k}
\end{equation}
