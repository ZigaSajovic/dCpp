...
\begin{izrek}[Algebra of Algorithms]
A differentible programming language $\dP_n:V\otimes T(V^*)\to V\otimes T(V^*)$ is a function algebra, with the product defined by $\eqref{eq:P_prod}$.
\end{izrek}

\subsection{Analytic machines}
