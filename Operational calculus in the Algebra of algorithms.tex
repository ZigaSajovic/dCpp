...
The developed facilitates functional transformations of programs in an arbitrary function basis (usually the one specified as optimal by the hardware manufacturer). Thus, the theory grants us the ability to choose programs' complexity, while knowing the order of the error of the approximation.

We show the existence of a procedure testing an object for a property to be sufficient for constructing a procedure enforcing that property upon it. Thus the theory opens new doors in program analysis.
\end{abstract}
