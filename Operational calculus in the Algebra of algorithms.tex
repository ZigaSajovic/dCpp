...
\begin{definicija}
  Let $x_i$ be the variable in memory. If 
  \begin{equation}
    \label{eq:free}
    \frac{\partial P_j}{\partial x_i}\equiv \delta_{ij}\wedge \frac{\partial P_i}{\partial x_j}\equiv \delta_{ij};
  \end{equation}
then the variable $x_i$ is called \emph{free}. If
\begin{equation}
  \label{eq:input}
  \frac{\partial P_j}{\partial x_i}\not\equiv \delta_{ij};
\end{equation}
then the variable $x_i$ is called \emph{input parameter}. And if
\begin{equation}
  \label{eq:output}
  \frac{\partial P_i}{\partial x_j}\not\equiv \delta_{ij};\quad 
\end{equation}
then the variable $x_i$ is called \emph{output value} of the program $P$.
\end{definicija}
...
the program. We also define corresponding vector subspaces of the program $P$.
\begin{definicija}
