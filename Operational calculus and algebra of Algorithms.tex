...
\end{equation}
Its derivative is extracted by projecting $H^\prime$ onto $\{\D\}$, to eliminate coefficients in the series $e^\D$, leaving only the derivative, as it need not be further differentiable for the use in the $step$ function.
