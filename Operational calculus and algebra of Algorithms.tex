...
\end{equation}
 ...
 Any program $P\in\dP$ containing control structures is differentiable on the entire domain $\Omega=\bigcup\limits_{\forall_i}\Omega_i$.
 \end{izrek}
 \begin{proof}
 ...
 \end{proof}
 \begin{corollary}
 Any program $P\in\dP$ containing control structures is infinitely-differentiable on the entire domain $\Omega=\bigcup\limits_{\forall_i}\Omega_i$.
 \end{corollary}
\begin{proof}
