...
\section{Analysis}\label{sec:Analysis}
  ...
  \end{equation}
  applying the operator $e^{\D_{T_k}}_1$ onto the sub-procedure, resulting in $e^{\D_{T_k}}_1(T^n_k)\in\dP_1$ and projecting the result onto the subspace spanned by $\{\D\}$ over $\mathbb{Z}_2$, as to eliminate coefficients, leaving only the derivative.
