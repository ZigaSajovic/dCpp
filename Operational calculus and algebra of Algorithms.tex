...
implemen infinitely-differentiable programming spaces and operators acting upon them.
...
\begin{definicija}[Virtual machine] The tuple $\langle \VV,\dP\rangle$ is a virtual computing machine.
  \begin{itemize}
  \item
