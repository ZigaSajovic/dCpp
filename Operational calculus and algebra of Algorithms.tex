...
Theory fully integrates control structures, thus retaining algorithmic control flow and the expressive power it possesses. It offers new insights into programs, as we demonstrate how to probe their inner structure, revealing what actions properties of the domain most react to. This enables us to extract archetypes from data, or alter it by imposing some property it lacks upon it.
