...
quotient of tensor algebra $T(V^*)$. To any element of
 ...
 \end{equation}
 For any element $\vv\in V$, the expression $e^{h\D}(\vv,\cdot)$ is a map $\dP\to
 U\otimes S(V^*)$, mapping a program to a polynomial. 
