...
\begin{definicija}[Automatically differentiable programs]
  ...
  \end{equation}
The Euclidian computing machine $(\VV, \E)$ is \emph{automatically differentiable}
...
(\VV\otimes\VV^*)+\ldots.$$
We will call $\VV_\infty$ the \emph{universal virtual memory space} of a
Euclidian computing machine. The term virtual memory is used as it is
not possible to embed $\VV_\infty$ into memory space $\VV$, making it similar to
