...
We demonstrated how the developed operational calculus is employed to such a cause, with countless methods from analysis available to be trivially transfered to the subject, as by the imagination and inventiveness of the employer of the theory.
  \printbibliography
\end{document}
