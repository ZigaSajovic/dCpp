...
Generalizations of recurrent \cite{RecurrentNet}, convolutional and highway  \cite{HighwayNet} neural networks, and features such as long short term memory \cite{LSTM}, are easily generated by this model, as they are all elements of the differential programming space $\dP$.
...
This offers a broad generalization of a concept of a neural network, with a rich theory of operational calculus developed in this paper at its disposal for the study and training of such objects, as we will demonstrate in this section.
