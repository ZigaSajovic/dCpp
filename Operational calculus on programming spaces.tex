...
\begin{opomba}
Generalizations of recurrent \cite{RecurrentNet}, convolutional, and highway neural networks \cite{HighwayNet}, and features such as long short term memory \cite{LSTM}, are easily generated by this model, as they are all elements of the differential programming space $\dP$.
\end{opomba}
