...
% \end{equation}
 \end{opomba}
   ...
   \begin{equation}
   e^{h\D}\vert_{v_0}(p_n\circ\cdots\circ p_1)=e^{h\D}\vert_{v_n}(p_n)\circ\cdots\circ e^{h\D}\vert_{v_0}(p_0)
   \end{equation}
   the wise chose of evaluation points is $v_{i}=p_{i-1}(v_{i-1})\in \VV$.
   \end{opomba}
